...
double TechnicalIndicators::mfi(const Slices &slices, int todayIndex, int period) {
...
double TechnicalIndicators::rsi(const Slices &slices, int todayIndex, int period) {
	assertValidIndex(slices, todayIndex);
	assertNaturalNum("period", period);
...
double TechnicalIndicators::stochastic_oscillator(const Slices &slices, int todayIndex, int periodhl, int periodk) {
	assertValidIndex(slices, todayIndex);
...
double TechnicalIndicators::max_open(const Slices &slices, int todayIndex, int period) {
	assertValidIndex(slices, todayIndex);
	assertNaturalNum("period", period);
...
double TechnicalIndicators::min_open(const Slices &slices, int todayIndex, int period) {
	assertValidIndex(slices, todayIndex);
	assertNaturalNum("period", period);
...
std::tuple<double, double, double> TechnicalIndicators::bollingerbands(const Slices &slices, int todayIndex, int length) {
	assertValidIndex(slices, todayIndex);
...
double TechnicalIndicators::sma(const Slices &slices, int todayIndex, int length) {
	assertValidIndex(slices, todayIndex);
	assertNaturalNum("length", length);
...
double TechnicalIndicators::stddev(const Slices &slices, int todayIndex, int length) {
	assertValidIndex(slices, todayIndex);
	assertNaturalNum("length", length);
...
void TechnicalIndicators::test(const Slices &slices, size_t todayIndex) {
	assertValidIndex(slices, todayIndex);
...
void TechnicalIndicators::assertNaturalNum(const std::string &s, int input) {
	if (input < 0) {
...
void TechnicalIndicators::assertValidIndex(const Slices &slices, int i) {
